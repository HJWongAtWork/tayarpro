  ...
  <div>
    <v-container class="fill-height">
      <v-row>
        ...
        <v-col cols="12" sm="12" md="6" class="d-flex flex-column align-center text-center">
          <div>
            <label class="italicBold f24-b20" style="display: flex">
              Other Channels
            </label>
            <label 
            style="font-size: 18px; display: flex; margin-bottom: 20px"
...
<script>
  ...
  export default {
    ...
    watch: {
      contentInput() {
        this.contentValid = this.contentInput !== '';
      }
    },
    computed: {
      formValid() {
        return this.valid && this.contentValid;
      }
    },
    methods: {
      handleSendBtn() {
