<template>
  <v-container fluid class="ma-auto pa-5" max-width="1000">
    ...
    <v-divider
      class="mx-5 my-7 border-md border-opacity-50 rounded-sm"
    ></v-divider>
    <v-row class="mt-0 px-8" justify="space-between">
      <v-col cols="12" class="ma-0 px-0 d-flex d-md-none">
        <div>
          <h1 class="font-weight-black text-capitalize">
            Your One Stop Tyre Service Center
          </h1>
          <p
            class="text-grey font-weight-bold font-italic text-subtitle-1 text-capitalize"
          >
            Automotive tyre services and maintenance that keeps your vehicle
            driving
          </p>
        </div>
      </v-col>
      ...
      <v-col cols="2" class="ma-0 px-0 d-none d-md-flex">
        ...
        <RouterLink to="/about-us"
          ><v-btn color="#ff3131">Know More ></v-btn></RouterLink
        >
      </v-col>
    </v-row>
    <v-row align="center">
      <v-col cols="12" sm="6" md="5">
        ...
        <div
          class="d-none d-sm-flex d-md-none justify-center align-center mt-9"
        >
          <RouterLink to="/about-us"
            ><v-btn color="#ff3131">Know More ></v-btn></RouterLink
          >
      ...
      <v-col cols="12" sm="6" md="7">
        <div class="intro-text text-justify px-8">
          <b>TayarPro</b>, a reputable tire shop in Petaling Jaya, Selangor,
          offers a comprehensive range of tire services including sales,
          installation, repair, alignment, and balancing. With their commitment
          to quality and customer satisfaction, <b>TayarPro</b> is a reliable
          choice for all your tire-related needs.<br /><br />

          <b>TayarPro</b> is more than just a tire shop; it's your partner in
          ensuring a safe and comfortable driving experience. Our team of
          skilled technicians is dedicated to providing top-notch service and
          personalized advice. Visit us today to discover the
          <b>TayarPro</b> difference and experience the peace of mind that comes
    ...
    <v-row class="mt-0 px-8" justify="space-between">
      ...
      <v-col cols="3" class="ma-0 px-0 d-none d-sm-flex">
        ...
        <RouterLink to="/products"
          ><v-btn color="#ff3131">More Tyres ></v-btn></RouterLink
        >
      </v-col>
    </v-row>
    ...
    <v-row class="mt-0 px-8" justify="space-between">
      ...
      <v-col cols="4" class="ma-0 px-0 d-none d-sm-flex">
        ...
        <RouterLink to="/services"
          ><v-btn color="#ff3131">More Services ></v-btn></RouterLink
        >
      </v-col>
    </v-row>
            ...
            <Transition name="fade">
              <div key="1" v-if="cardData.showAdditionalText">
                <div class="imageOpacity">
                  <v-row>
                    <v-col>
                      <div class="imageContainerTitle">
                        {{ cardData.title }}
                      </div>
                      <div class="mx-5 additional-text">
    ...
    <v-row align="center" justify="center" class="px-8">
      <v-col
        align="center"
        v-for="(item, i) in tayarProStrengths"
        :key="i"
        cols="12"
        sm="6"
        md="3"
      ...
      >
        ...
        >
          ...
          <v-card-text
            v-if="item.cert.length > 0"
            class="text-grey font-italic mx-3"
            >{{ item.cert }}</v-card-text
          >
        </v-card>
      </v-col>
    </v-row>
    ...
    <v-row class="my-5 px-8" justify="space-between">
      ...
      <v-col cols="12" md="6" class="ma-0 px-0" align="center">
        <RouterLink to="/location"
          ><v-btn color="#ff3131" class="ma-2" width="200"
            ><v-icon class="mr-1">mdi-map-marker</v-icon> Location ></v-btn
          >
        </RouterLink>
        <RouterLink to="/contact-us"
          ><v-btn color="#ff3131" class="ma-2" width="200"
            ><v-icon class="mr-1">mdi-phone-incoming</v-icon> Contact Us
            ></v-btn
          ></RouterLink
        >
      </v-col>
...
const cardDataList = ref<CardData[]>([
  {
    ...
    additionalText:
      "Tyre installation services involve professionally fitting new tires onto a vehicle's wheels. This includes removing old tires, cleaning wheels, mounting new tires, balancing them, and checking torque. These services are crucial for vehicle safety, performance, and tire longevity.",
  },
  {
    imageSrc: tyreTuning,
    title: "Tyre Tuning",
    ...
    showAdditionalText: false,
    additionalText:
      "Tyre tuning services involve optimizing a vehicle's tires for performance and efficiency. This can include adjusting tire pressure, alignment, and rotation. By ensuring that tires are properly tuned, drivers can improve fuel economy, enhance handling, and extend tire life.",
  },
  {
    ...
    showAdditionalText: false,
    additionalText:
      "Tyre consultation services offer expert advice on tire selection, maintenance, and performance. Experienced professionals can help customers choose the right tires for their specific needs, provide guidance on tire care and maintenance practices, and offer recommendations for improving tire performance and fuel efficiency.",
  },
]);
...
const toggleAdditionalText = (index: number) => {
  cardDataList.value[index].showAdditionalText =
    !cardDataList.value[index].showAdditionalText;
};
