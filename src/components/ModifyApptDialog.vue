<template>
    <v-dialog v-model="dialog" max-width="500px" min-width="400px">
        <v-card class="pa-auto py-5">
            <v-row>
                <v-col cols="12">
                    <v-card-title class="text-center py-0">
                        <span class="text-h6">Edit Item</span>
                    </v-card-title>
                </v-col>
            </v-row>
            ...
            <v-card-actions class="px-5">
                ...
                <v-btn width="100" color="#FF3131" variant="elevated" @click="saveChanges">
                    Save
                </v-btn>
            </v-card-actions>
        </v-card>
