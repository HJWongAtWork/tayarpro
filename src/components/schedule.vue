  ...
  {{ formattedDate }}
              ...
              <tbody>
                  ...
                  >
                      ...
                      >
                          ...
                          <v-chip
                              v-if="(schedule[hour][bay].year !== -1 && userType === 'customer') && schedule[hour][bay].id !== newApptInScheduleFormat.id"
                              color="red lighten-2"
                              outlined
                              class="appointment-chip"
                          >
                          ...
                          <v-chip
                              v-else-if="schedule[hour][bay].year === -1"
      ...
      <v-form v-model="addFormValid" :disabled="userType === ''">
          <v-row>
              ...
              <v-col cols="12" sm="12" md="4">
                  <v-select
                      v-model="selectedCarStr"
                      :items="formattedCarText"
                      label="Select Car"
                      outlined
                      dense
                      :rules="[rules.required]"
              ...
              <v-row v-if="selectedCarStr === 'Add New Car'">
                  ...
                  <v-col cols="12" sm="12" md="4">
                      <v-text-field
                          ...
                          outlined
                          dense
                          :rules="[rules.required, rules.year, rules.numberOnly]"
                      ></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="12" md="4">
                      <v-text-field
                          v-model="newNumberPlate"
                  ...
                  <v-col cols="12" sm="12" md="4">
                      <v-text-field
                          v-model="newTyreSize"
                          label="Enter Tyre Size(example: 215/65R15)"
                          outlined
                          dense
                          :rules="[rules.tyreFormat]"
                      ></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="12" md="4" style="font-size: 13px">
                      *Tyre Size is Optional. You may proceed to confirm the
                      appointment.
                  </v-col>
              </v-row>
          </v-row>
     ...
     ></v-checkbox> -->
              ...
              <v-col cols="12" v-if="newApptInScheduleFormat.year !== -1" align="center">
                  appointment slot is on hold, press complete to proceed OR
                  press
...
<script>
  ...
  import { appointmentComposable } from '@/composables/appointmentComposable';
   ...
   //  const selectedCarObj = ref({});
   //  selectedCarObj.value = computed(() => {
   //   let car = vehicles.value.find(vehicle => vehicle.plateNumber === plateNumberOfSelectedCar(selectedCarStr.value));
   //   return car;
   //  });
