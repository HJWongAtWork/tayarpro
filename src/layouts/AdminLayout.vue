<template>
  <v-app>
    ...
    <v-navigation-drawer app permanent color="red">
      <v-list>
        <v-list-item>Admin Menu Item</v-list-item>
        <v-list-item>Customer Feedback</v-list-item>
        <v-list-item>Appointments</v-list-item>
      </v-list>
    </v-navigation-drawer>
    <v-app-bar app color="red">
      <v-toolbar-title>Admin Layout</v-toolbar-title>
    </v-app-bar>
    <v-main>
      <router-view />
    </v-main>
